      ...
      <div className="flex flex-col gap-8 overflow-y-auto pb-10 custom-scrollbar pr-2">
        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-4 gap-2">
                ...
                <button onClick={() => handleFlip('X')} className={`h-10 rounded-lg flex items-center justify-center transition-colors ${geometry.flipX ? 'bg-blue-500 text-white' : 'bg-white/5 hover:bg-white/10 text-white'}`} title="Flip Horizontal">
                ...
                <button onClick={() => handleFlip('Y')} className={`h-10 rounded-lg flex items-center justify-center transition-colors ${geometry.flipY ? 'bg-blue-500 text-white' : 'bg-white/5 hover:bg-white/10 text-white'}`} title="Flip Vertical">
        ...
        <div className="flex flex-col gap-3">
            ...
            <input
                ...
                className="w-full h-1.5 appearance-none rounded-full bg-white/10 cursor-pointer accent-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            />
        </div>
        ...
        <div className="flex flex-col gap-3">
            ...
            <button 
                onClick={triggerCrop}
                className="w-full py-2.5 mt-2 rounded bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm shadow-[0_4px_15px_rgba(37,99,235,0.4)] transition-all"
            >
                Apply Crop
            </button>
        </div>
