    ...
    <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center justify-between mb-8">
        ...
        <button 
          ...
          className="w-7 h-7 rounded bg-red-500/10 hover:bg-red-500 hover:text-white text-red-500 transition-colors flex items-center justify-center cursor-pointer"
          title="Delete Object"
        >
      ...
      <div className="flex flex-col gap-6 overflow-y-auto pb-10 custom-scrollbar pr-2">
        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
                ...
                />
                <span className="text-sm font-mono text-white/80 uppercase">{fillColor}</span>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
            <div className="flex justify-between items-end">
                <span className="text-xs font-semibold text-slate-400">Opacity</span>
                <span className="text-xs font-mono text-slate-500 w-8 text-right bg-white/5 rounded px-1 py-0.5">{opacity}%</span>
            </div>
            <input
                type="range"
                min={0}
        ...
        {selectedObjectType === 'text' && (
            <>
                ...
                <div className="flex flex-col gap-3">
                     <span className="text-xs font-semibold text-slate-400">Size Tracking</span>
                     <input
                        type="range"
                        min={10}
                        max={200}
