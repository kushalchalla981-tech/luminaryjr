        ...
        <div className="flex w-full h-full bg-transparent overflow-hidden">
            ...
            */}
            ...
            <div className="relative h-full flex flex-col z-20">
              ...
              />
              <div
                className="w-16 h-full flex flex-col items-center py-4 gap-4 bg-white/5 backdrop-blur-[40px] border-r border-white/10 relative z-10 shadow-[8px_0_32px_0_rgba(0,0,0,0.5)] transition-all"
                style={{ WebkitBackdropFilter: "blur(40px)" }}
              >
                <button 
                  onClick={() => setActiveTool('adjust')}
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'adjust' ? 'bg-yellow-500 text-white shadow-[0_0_15px_rgba(255,215,0,0.6)]' : 'bg-white/5 text-slate-400 hover:bg-white/10 hover:text-white'}`}
                  title="Adjust"
                >
                ...
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'filters' ? 'bg-yellow-500 text-white shadow-[0_0_15px_rgba(255,215,0,0.6)]' : 'bg-white/5 text-slate-400 hover:bg-white/10 hover:text-white'}`}
                  title="Filters"
                >
                ...
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'crop' ? 'bg-yellow-500 text-white shadow-[0_0_15px_rgba(255,215,0,0.6)]' : 'bg-white/5 text-slate-400 hover:bg-white/10 hover:text-white'}`}
                  title="Crop & Geometry"
                >
                ...
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'overlays' ? 'bg-yellow-500 text-white shadow-[0_0_15px_rgba(255,215,0,0.6)]' : 'bg-white/5 text-slate-400 hover:bg-white/10 hover:text-white'}`}
            ...
            <div className="relative h-full hidden md:flex flex-col z-20 shrink-0">
                ...
                />
                <div
                  className="w-80 h-full bg-white/5 backdrop-blur-[40px] border-l border-white/10 p-6 relative z-10 shadow-[-8px_0_32px_0_rgba(0,0,0,0.5)] overflow-hidden"
                  style={{ WebkitBackdropFilter: "blur(40px)" }}
                >
                    {selectedObjectType ? (
