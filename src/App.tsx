            ...
            <div className="relative h-full flex flex-col z-20">
              ...
              >
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'adjust' ? 'bg-black text-yellow-400 border border-yellow-500 shadow-[0_0_15px_rgba(255,215,0,0.3)]' : 'bg-black text-slate-400 hover:bg-zinc-900 border border-white/10 hover:text-white'}`}
                  title="Adjust"
                >
                ...
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'filters' ? 'bg-black text-yellow-400 border border-yellow-500 shadow-[0_0_15px_rgba(255,215,0,0.3)]' : 'bg-black text-slate-400 hover:bg-zinc-900 border border-white/10 hover:text-white'}`}
                  title="Filters"
                >
                ...
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'crop' ? 'bg-black text-yellow-400 border border-yellow-500 shadow-[0_0_15px_rgba(255,215,0,0.3)]' : 'bg-black text-slate-400 hover:bg-zinc-900 border border-white/10 hover:text-white'}`}
                  title="Crop & Geometry"
                >
                ...
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'overlays' ? 'bg-black text-yellow-400 border border-yellow-500 shadow-[0_0_15px_rgba(255,215,0,0.3)]' : 'bg-black text-slate-400 hover:bg-zinc-900 border border-white/10 hover:text-white'}`}
                ...
                <button 
                  ...
                  className={`w-10 h-10 rounded-xl transition-colors flex items-center justify-center cursor-pointer ${activeTool === 'ai' ? 'bg-purple-500 text-white shadow-[0_0_15px_rgba(168,85,247,0.6)]' : 'bg-black text-slate-400 hover:bg-zinc-900 border border-white/10 hover:text-purple-400'}`}
